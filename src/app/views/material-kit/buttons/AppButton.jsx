  ...
  return (
    <AppButtonRoot>
      ...
      <SimpleCard title="icon buttons">
        ...
        <IconButton className="button" aria-label="Delete" disabled color="success">
          <Icon>delete</Icon>
        </IconButton>
        ...
        <IconButton color="success" className="button" aria-label="Add to shopping cart">
      ...
      <SimpleCard title="outlined buttons">
        <Fab color="success" aria-label="Add" className="button">
          <Icon>add</Icon>
        </Fab>
