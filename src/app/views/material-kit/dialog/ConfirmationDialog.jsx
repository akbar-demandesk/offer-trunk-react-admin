    ...
    <DialogRoot>
      <List component="div" role="list">
        <ListItem button divider disabled role="listitem">
          <ListItemText success="Interruptions" />
        </ListItem>
        ...
        <ListItem
          ...
          role="listitem"
        >
          <ListItemText success="Phone ringtone" secondary={value} />
        </ListItem>

        <ListItem button divider disabled role="listitem">
          <ListItemText success="Default notification ringtone" secondary="Tethys" />
        </ListItem>
