  ...
  return (
    <Container>
      ...
      <SimpleCard title="Line Chart">
        <LineChart
          height="350px"
          color={[theme.palette.success.main, theme.palette.success.light]}
        />
      </SimpleCard>
      ...
      <SimpleCard title="Comparison Chart">
        <ComparisonChart
          height="350px"
          color={[theme.palette.success.dark, theme.palette.success.light]}
        />
      </SimpleCard>
      ...
      <SimpleCard title="Area Chart">
        <AreaChart height="350px" color={[theme.palette.success.main]} />
      </SimpleCard>
    </Container>
  );
};
