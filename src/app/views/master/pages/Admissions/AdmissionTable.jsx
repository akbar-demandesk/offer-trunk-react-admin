...
import { getAdmissions } from 'app/helper/ApiUrlHelper';
                ...
                <Grid item lg={4} md={4} sm={12} xs={12} sx={{ mt: 2 }}>
                  <Box>
                    <Button color="success" variant="contained">
                      <Icon>add</Icon>
                      <Span onClick={(e) => navigation('/AddUpdateAdmission', { state: null })}>
                        Add Admission
                      </Span>
                    </Button>
                  </Box>
                  ...
                  {RowData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(
                    (subscriber, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell align="left">{subscriber.name_student}</TableCell>
                        <TableCell align="center">{subscriber.name_course}</TableCell>
                        <TableCell align="center">{subscriber.amount_charged}</TableCell>
                        <TableCell align="center">{subscriber.amount_outstanding}</TableCell>
                        <TableCell align="center">
                          {new Date(subscriber.admission_date).toLocaleDateString('en-GB')}
                        </TableCell>
                        <TableCell align="center">
                          <IconButton
                            onClick={(e) =>
                              navigation('/AddUpdateAdmission', {
                          ...
                          >
                            <Icon color="primary">receipts</Icon>
                          </IconButton>
                        </TableCell>
                      </TableRow>
                    )
